...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtAuthenticationFilter(AuthenticationManager authenticationManager, final JwtConfig jwtConfig) {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res,
        ...
        String token = null;
        token = Jwts.builder()
                .setSubject(((UserDetails) auth.getPrincipal()).getUserId().toString())
